...
//void DecCBFun(int nPort,char * pBuf,int nSize,FRAME_INFO * pFrameInfo, int nReserved1,int nReserved2){
...
void fRealDataCallBack_V30(LONG lRealHandle, DWORD dwDataType, BYTE *pBuffer, DWORD dwBufSize, void* pUser)
{
    ...
    switch (dwDataType)
    {
        case NET_DVR_SYSHEAD:
            ...
            //if (!PlayM4_Play(pHandle->iPlayPort,NULL)) //播放开始  这一步必须有
            //{
           //     break;
            //}
            
            //PlayM4_SetDecCallBack(pHandle->iPlayPort,DecCBFun);  //执行回调
            break;
        default:
