...
void Test_FindFile_V30(int iUserID, int iChan)
{
     ...
     struFileCond.lChannel = iChan;
     struFileCond.dwFileType = 0xff;
     struFileCond.struStartTime.dwYear = 2016;
     struFileCond.struStartTime.dwMonth =6;
     struFileCond.struStartTime.dwDay = 28;
     struFileCond.struStopTime.dwYear = 2016;
     struFileCond.struStopTime.dwMonth = 6;
     struFileCond.struStopTime.dwDay = 29;
...
void Test_FindFileByEvent(int iUserID)
{
     ...
     struEventParam.struStartTime.dwYear = 2016;
     struEventParam.struStartTime.dwMonth = 6;
     struEventParam.struStartTime.dwDay = 28;
     struEventParam.struEndTime.dwYear = 2016;
     struEventParam.struEndTime.dwMonth = 6;
     struEventParam.struEndTime.dwDay = 29;
     struEventParam.byValue = 1;
     struEventParam.uSeniorParam.struMotionParamByValue.wMotDetChanNo[0] = 33;
     struEventParam.uSeniorParam.struMotionParamByValue.wMotDetChanNo[0] = 0xffff;
